...
export function SessionRecordingPlayer({
  ...
  // Legacy RDP/VNC/Telnet recordings were captured in the Guacamole protocol format.
  // That player is gone; the raw file is still downloadable from the session-log list.
  if (log.format === "guacamole") {
    return (
      <div className="p-4 text-xs text-muted-foreground">
        {t("sessionLogs.guacamoleFormatUnsupported")}
      </div>
    );
  }
