...
import { HostFilesTab } from "./HostEditorFeatureTabs";
...
export function HostEditor({
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const data = buildHostEditorPayload(form);
      let saved: SSHHost;
    ...
    <div className="flex flex-col gap-3">
      ...
      >
        <div className="flex flex-col gap-3">
            ...
            <>
              ...
              >
                <div className="flex flex-col gap-4 py-3">
                      ...
                      <div className="flex flex-col gap-1.5 col-span-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <a
                              href="https://docs.termelix.site/features/authentication/vault"
                              target="_blank"
                              rel="noreferrer"
                  ...
                  {authMethod === "opkssh" && (
                    <div className="flex flex-col gap-2 border-t border-border pt-3">
                      <div className="flex items-center justify-between">
                        ...
                        <a
                          href="https://docs.termelix.site/features/authentication/opkssh"
                          target="_blank"
                          rel="noreferrer"
                          className="text-[10px] text-accent-brand hover:underline"
                        >
                  ...
                  {/* Sudo password auto-fill is gone, so the editor no longer asks for one.
                      Nothing could consume it: having the server type a stored secret into the PTY
                      is a credential-reveal primitive however it is gated, and it was removed.
                      Soliciting a password that nothing can use — and its old description promised
                      privileged commands that never ran — is worse than not offering the feature:
                      it is a stored credential that is pure liability. */}
                </div>
              </SectionCard>
            </>
          )}
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      >
                        {Object.entries(TERMINAL_THEMES)
                          .filter(
                            ([key]) =>
                              key !== "termelixDark" && key !== "termelixLight",
                          )
                          .map(([key, theme]) => (
                          ...
                          <div className="flex items-center gap-1.5">
                            <input
                              ...
                              value={
                                ...
                                TERMINAL_THEMES.termelixDark.colors[key]
                              }
                              onChange={(e) =>
                                setField("customThemeColors", {
                                  ...(form.customThemeColors ??
                  ...
                  <SettingRow
                    ...
                    description={
                      <>
                        ...
                        <a
                          href="https://docs.termelix.site/features/terminal/session-recording"
                          target="_blank"
                          rel="noreferrer"
                          className="text-accent-brand hover:underline"
                        >
                  ...
                  <SettingRow
                    ...
                    description={
                      <>
                        ...
                        <a
                          href="https://docs.termelix.site/features/terminal/command-history"
                          target="_blank"
                          rel="noreferrer"
                          className="text-accent-brand hover:underline"
                        >
          ...
          {activeTab === "host-metrics" && (
            <HostStatsTab form={form} setField={setField} />
          )}
        </div>
      </fieldset>
      ...
      <div className="flex justify-end gap-3 mt-3 mb-6">
        <Button
          ...
          disabled={saving}
        >
          {t("hosts.editorActions.cancelBtn")}
        </Button>
        {!readOnly && (
          <Button
            variant="outline"
          ...
          >
            {saving
              ? t("hosts.editorActions.savingBtn")
              : host
                ? t("hosts.editorActions.updateHostBtn")
                : t("hosts.editorActions.addHostBtn")}
          </Button>
        )}
      </div>
    </div>
