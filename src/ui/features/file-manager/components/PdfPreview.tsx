...
// `pdfjs-dist` is a direct import, so it is a direct dependency — it used to resolve only because
// npm hoisted react-pdf's copy, which a different install layout or a react-pdf bump would end.
// Pinned to the exact version react-pdf pins: the worker and the library must be the same build or
// PDF.js refuses to load with a version mismatch.
