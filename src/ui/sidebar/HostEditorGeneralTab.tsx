...
import { Globe, Plus, Tag, Trash2, X } from "lucide-react";
...
export function HostEditorGeneralTab({
  ...
  React.useEffect(() => {
    ...
    load();
    window.addEventListener("termelix:hosts-changed", load);
    return () => {
      cancelled = true;
      window.removeEventListener("termelix:hosts-changed", load);
    };
  }, []);
  ...
  // There is no Protocols card: SSH is the only connection type, so a picker with one
  // option could only ever be switched *off*, into a host that lists but cannot be opened.
  // `buildHostEditorPayload` pins `enableSsh: true` instead.
  return (
    <>
      <SectionCard
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <a
                  href="https://docs.termelix.site/features/networking/wake-on-lan"
                  target="_blank"
                  rel="noreferrer"
        ...
        <div className="flex flex-col gap-3 border-t border-border pt-4 pb-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <a
                href="https://docs.termelix.site/features/networking/port-knocking"
                target="_blank"
                rel="noreferrer"
                className="text-[10px] text-accent-brand hover:underline"
              >
